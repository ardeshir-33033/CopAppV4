...
class ConflictsPrice {
  ...
  ConflictsPrice.fromJson(Map<String, dynamic> json) {
  ...
  List<ConflictsPrice>? listFromJson(dynamic jsns) {
    if (jsns != null) {
      return jsns.map<ConflictsPrice>((ct) {
        return ConflictsPrice.fromJson(ct);
      }).toList();
    }
